...
func _ready():
	...
	GameManagerSingleton.player_deregistered.connect(_remove_player)
...
func _update_player_input():
	...
	var is_input_disabled = (
		is_player_in_vent || is_minigame_window_visible || is_voting_in_progress || is_loading_screen_visible || !$KillScreen == null
	)
