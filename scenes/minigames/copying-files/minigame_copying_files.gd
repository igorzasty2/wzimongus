...
func _on_confirm_button_down():
	# Załaduj grafikę
	var texture = preload("res://assets/kopiowanie1.png")
	...
	get_tree().change_scene_to_file("res://minigame_copying_files_end.tscn")
