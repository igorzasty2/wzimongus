...
@onready var minigame_container = camera.get_node("MinigameContainer")
@onready var use_button: TextureButton = camera.get_node("UseButton")
@onready var close_button: TextureButton = camera.get_node("CloseButton")
@onready var minigame_background: ColorRect = camera.get_node("MinigameBackground")
